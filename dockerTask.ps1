...
.PARAMETER Clean
Removes the image weatherlink and kills all containers based on that image.
...
Build a Docker image named weatherlink
#>
...
$imageName="weatherlink"
$projectName="weatherlink"
$serviceName="weatherlink"
