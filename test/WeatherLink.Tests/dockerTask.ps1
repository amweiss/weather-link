...
.PARAMETER Clean
Removes the image weatherlink.tests and kills all containers based on that image.
...
Build a Docker image named weatherlink.tests
#>
...
$imageName="weatherlink.tests"
$projectName="weatherlinktests"
$serviceName="weatherlink.tests"
